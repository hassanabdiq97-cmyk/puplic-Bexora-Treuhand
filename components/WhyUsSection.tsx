  ...
  return (
    <section id="why-us" className="relative py-20 md:py-48 bg-slate-50 dark:bg-[#020617] text-slate-900 dark:text-white overflow-hidden scroll-mt-20 transition-colors duration-500">
      ...
      <div className="px-6 md:px-8 max-w-7xl mx-auto relative z-10">
          ...
          {/* The 3 Pillars */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-12 animate-fade-up delay-300 mb-16 md:mb-24">
          ...
          {/* Final CTA Anchor */}
          <div className="animate-fade-up delay-400 flex justify-center w-full">
            <div className="relative group w-full sm:w-auto">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200 hidden sm:block"></div>
                <MagneticButton variant="primary" className="!w-full sm:!w-auto !px-8 md:!px-12 !py-5 md:!py-6 !text-xs md:!text-sm !font-black !tracking-widest" onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}>
