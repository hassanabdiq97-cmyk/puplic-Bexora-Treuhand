...
export default function AboutSection({ lang = 'DE' }: AboutSectionProps) {
  ...
  return (
    <section id="about" className="py-32 md:py-48 px-6 bg-slate-50 dark:bg-dark-950 scroll-mt-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-32 max-w-5xl">
          ...
          <h2 className="text-6xl md:text-8xl font-black mb-12 tracking-tighter text-slate-900 dark:text-white leading-[0.9]">
            {t.title} <br/>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-40">
           <div className="relative group">
              ...
              <div className="relative h-full p-12 rounded-[3rem] bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/5 flex flex-col justify-center">
                 <Lightbulb size={64} className="text-blue-600 mb-8" strokeWidth={1} />
                 <h3 className="text-3xl font-black text-slate-900 dark:text-white mb-4 tracking-tight">{t.vision}</h3>
